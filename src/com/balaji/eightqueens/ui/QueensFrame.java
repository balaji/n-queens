package com.balaji.eightqueens.ui;
...
public class QueensFrame extends JFrame {
  ...
  static int N = EightQueensRules.LIMIT;

  public QueensFrame(List<List<Position>> lst) {
    lists = lst;
    setLookAndFeel(1);
    drawChessBoard();
    drawButtons();
  ...
  private void setLookAndFeel(int option) {
    try {
      ...
      Logger.getLogger(QueensFrame.class.getName()).log(Level.SEVERE, null, ex);
